...
export default function AppSubmissionFormPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast.success('Form submitted successfully!'); // Using sonner for feedback
    router.push('/submit-app/confirmation');
  };
  ...
  return (
    <div className="min-h-screen bg-black text-white py-16">
      <section className="max-w-4xl mx-auto px-6">
        ...
        <form onSubmit={handleSubmit} className="bg-gray-800 rounded-xl p-6 shadow-lg animate-[fadeIn_0.5s_ease-in]">
