...
//   title: "Delhi 365 - Satta Matka  App - Apps on Google Play",
//   description:
//     "Delhi 365 - Play Satta Matka  Game. Daily contests, instant withdrawals. Rated 4.5★ by 50K+ users. Download now!",
//   openGraph: {
//     title: "Delhi 365 - Satta Matka  App",
//     description:
//       "Official Delhi 365  gaming app. Play Satta Matka games and win real cash prizes daily.",
//     url: "https://play.google.com/store/apps/details?id=com.delhi365",
//   },
// };
...
//               <span className="text-gray-600">Rated for 3+</span>
//             </div>
...
//               target="_blank"
//               rel="noopener noreferrer"
//               className="inline-flex items-center bg-[#1a73e8] hover:bg-[#1b66c9] text-white px-6 py-3 rounded-lg font-medium shadow-sm"
//             >
//               <svg
...
//                   <div
//                     key={item}
//                     className="flex-shrink-0 w-64 h-auto rounded-lg border border-gray-200 overflow-hidden"
//                   >
//                     <div>
//                       <img
//                         src={item}
...
//         {/* About App */}
//         {/* <section className="mb-8">
//           <h2 className="text-xl font-medium mb-4">About this game</h2>
//           <div className="bg-white rounded-lg shadow-sm p-6">
//             <p className="mb-4">
//               Delhi 365 is India's premier Satta Matka gaming platform where you
//               can play your favorite Matka games, predict results, and win real
//               cash prizes daily.
//             </p>
//             <p className="mb-4">
//               Experience the thrill of Satta Matka in a completely legal and
//               secure environment with instant withdrawals and 24/7 customer
//               support.
//             </p>
//             <p>
//               <strong>Updated:</strong> June 2024
//               <br />
//               <strong>Size:</strong> 13MB
//               <br />
//               <strong>Downloads:</strong> 50,000+
//               <br />
//               <strong>Current Version:</strong> 2.3.1
//               <br />
//               <strong>Requires Android:</strong> 7.0 and up
//               <br />
//             </p>
//           </div>
//         </section> */}
...
//               like{" "}
//               <strong>Kalyan Matka, Milan Day/Night, Rajdhani Day/Night</strong>
//               , and other popular variants with <strong>100% fair play</strong>{" "}
//               and <strong>transparent results</strong>.
//             </p>
...
//               <li>
//                 <strong>Real cash winnings</strong> - Withdraw instantly via
//                 UPI, Paytm, or Bank Transfer
//               </li>
//               <li>
//                 <strong>Beginner-friendly</strong> - Easy tutorials for new
//                 players with daily free games
//               </li>
//               <li>
//                 <strong>Live results & notifications</strong> - Get instant
//                 updates on game outcomes
//               </li>
//               <li>
//                 <strong>Multiple game modes</strong> - Single, Jodi, Panna,
//                 Sangam, and more
//               </li>
//               <li>
//                 <strong>Secure & legal</strong> - Fully compliant with Indian
//                 gaming regulations
//               </li>
//               <li>
//                 <strong>24/7 customer support</strong> - Dedicated help for all
//                 player queries
//               </li>
//             </ul>

//             <p className="mb-4">
//               Join <strong>50,000+ daily players</strong> who trust Delhi 365
//               for the most exciting
//               <strong> Satta Matka fantasy experience</strong> with the{" "}
//               <strong>highest payout rates</strong>
//               in the industry. Our <strong>
//                 AI-powered fair play system
//               </strong>{" "}
//               ensures equal winning opportunities for all players.
//             </p>
...
//                   <strong>Updated:</strong> June 2024
//                   <br />
//                   <strong>Size:</strong> 13MB (Lightweight & Fast)
//                   <br />
//                   <strong>Downloads:</strong> 50,000+
//                   <br />
//                   <strong>Current Version:</strong> 2.3.1
...
//                   <strong>Requires Android:</strong> 7.0 and up
//                   <br />
//                   <strong>Daily Active Users:</strong> 10,000+
//                   <br />
//                 </p>
//               </div>
//               <div>
...
//                 <p>
//                   <strong>Daily Payouts:</strong> ₹5 Lakhs+
//                   <br />
//                   <strong>Withdrawal Time:</strong> Under 5 Minutes
//                   <br />
//                   <strong>Minimum Deposit:</strong> ₹50
//                   <br />
//                   <strong>Minimum Withdrawal:</strong> ₹100
//                   <br />
//                   <strong>Success Rate:</strong> 99.9%
//                   <br />
//                   <strong>Customer Rating:</strong> 4.7/5 (Play Store)
//                   <br />
//                 </p>
//               </div>
//             </div>
...
//               <strong>Note:</strong> Delhi 365 is a fantasy prediction game
//               platform for entertainment purposes only. Play responsibly. Must
...
//         {/* Features */}
//         <section className="mb-8">
//           <h2 className="text-xl font-medium mb-4">Why Choose Delhi 365?</h2>
//           <div className="flex flex-col lg:flex-row gap-6">
//             {/* Features List */}
//             <div className="bg-white rounded-lg shadow-sm p-6 lg:w-1/2">
...
//                   </div>
//                   <div>
//                     <h3 className="font-semibold">20+ Matka Games</h3>
//                     <p className="text-gray-600 text-sm">
//                       Kalyan Matka, Milan Day/Night, Rajdhani, Main Mumbai,
//                       DPBOSS and more with live results
//                     </p>
//                   </div>
//                 </li>
...
//                     <p className="text-gray-600 text-sm">
//                       Get money in 2 minutes to Paytm, UPI, Bank (Minimum ₹100
//                       withdrawal)
//                     </p>
//                   </div>
//                 </li>
...
//                   </div>
//                   <div>
//                     <h3 className="font-semibold">Daily Bonus & Rewards</h3>
//                     <p className="text-gray-600 text-sm">
//                       Get ₹50 free on first deposit + daily login bonus up to
//                       ₹500
//                     </p>
//                   </div>
//                 </li>
...
//                   </div>
//                   <div>
//                     <h3 className="font-semibold">24/7 Expert Support</h3>
//                     <p className="text-gray-600 text-sm">
//                       Instant chat support with Matka experts for game
//                       strategies
//                     </p>
//                   </div>
//                 </li>
...
//                   </div>
//                   <div>
//                     <h3 className="font-semibold">Secure & Legal</h3>
//                     <p className="text-gray-600 text-sm">
//                       RNG certified, 256-bit SSL encrypted transactions
//                     </p>
//                   </div>
//                 </li>
//               </ul>
...
//             {/* Feature Screenshot */}
//             <div className="bg-white rounded-lg shadow-sm p-6 lg:w-1/2 flex flex-col items-center justify-center">
//               <div className="relative w-full max-w-xs mx-auto">
//                 {/* Phone frame mockup */}
//                 <div className="relative mx-auto border-gray-800 dark:border-gray-800 bg-gray-800 border-[14px] rounded-[2.5rem] h-[600px] w-[300px]">
//                   <div className="h-[32px] w-[140px] bg-gray-800 top-0 rounded-b-lg left-1/2 -translate-x-1/2 absolute"></div>
//                   <div className="rounded-[2rem] overflow-hidden w-[272px] h-[570px] bg-white">
//                     {/* App screenshot */}
//                     <img
//                       src="/feature.jpeg"
//                       alt="Delhi 365 App Features"
//                       className="w-full h-full object-cover"
//                     />
//                   </div>
//                 </div>
//                 <div className="absolute -bottom-12 left-1/2 -translate-x-1/2 bg-blue-100 text-blue-800 px-4 py-2 rounded-full text-sm font-medium">
//                   Live Matka Results Screen
//                 </div>
//               </div>
//             </div>
//           </div>
...
//               <div className="text-gray-600 text-sm">Daily Winners</div>
//             </div>
//             <div className="bg-white p-4 rounded-lg shadow-sm text-center">
//               <div className="text-2xl font-bold text-blue-600">₹5 Lakh+</div>
//               <div className="text-gray-600 text-sm">Daily Payouts</div>
//             </div>
//             <div className="bg-white p-4 rounded-lg shadow-sm text-center">
//               <div className="text-2xl font-bold text-purple-600">98%</div>
//               <div className="text-gray-600 text-sm">Withdrawal Success</div>
//             </div>
//             <div className="bg-white p-4 rounded-lg shadow-sm text-center">
//               <div className="text-2xl font-bold text-yellow-600">4.7★</div>
//               <div className="text-gray-600 text-sm">Play Store Rating</div>
//             </div>
//           </div>
//         </section>
//         {/* Ratings & Reviews */}
//         <section className="mb-8">
//           <h2 className="text-xl font-medium mb-4">Ratings & reviews</h2>
//           <div className="bg-white rounded-lg shadow-sm p-6">
//             <div className="flex items-center mb-6">
//               <div className="text-5xl font-bold mr-6">4.5</div>
//               <div>
...
//                   </svg>
//                 </div>
//                 <div className="text-sm text-gray-600">1,240 reviews</div>
//               </div>
//             </div>
...
//                   </div>
//                 </div>
//                 <h3 className="font-medium mb-1">Best Matka App!</h3>
//                 <p className="text-gray-700">
//                   I've tried many apps but Delhi 365 is the best. Fast
//                   withdrawals and great customer support. Highly recommended!
//                 </p>
...
//                 </h3>
//                 <p className="text-gray-700">
//                   The app is good but sometimes the results are delayed.
//                   Otherwise, the gaming experience is smooth.
//                 </p>
//                 <div className="text-xs text-gray-500 mt-2">
...
//                 ©2024 Delhi Games. All rights reserved
//               </div>
//             </div>
